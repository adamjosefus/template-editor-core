import { Vector, Utils, Transform, Fill, Stroke, Shadow } from "../../../node_modules/@templatone/kreslo/kreslo.js";
export class TransformFeedback {
    ...
    get position() { return this._pivot.position; }
    set position(v) { this._pivot.position = v; }
    get scale() { return this._pivot.scale; }
    set scale(v) { this._pivot.scale = v; }
    get rotation() { return this._pivot.rotation; }
    set rotation(v) { this._pivot.rotation = v; }
